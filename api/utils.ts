  ...
  for (const i in obj) {
    ...
    if (typeof val === 'string') {
      if (val.startsWith('https://')) {
        obj[key] = val
          .replace('storage1.picacomic.com', 'pica-img.120261.xyz/proxy/https://s3.picacomic.com')
          .replace('storage-b.picacomic.com', 'pica-img.120261.xyz/proxy/https://s3.picacomic.com')
          .replace('img.picacomic.com', 'pica-img.120261.xyz/proxy/https://s3.picacomic.com')
